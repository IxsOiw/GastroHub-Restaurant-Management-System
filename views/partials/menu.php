...
<div class="tw-mt-[5%] tw-flex tw-w-full tw-place-content-center tw-gap-5 max-md:tw-flex-wrap">
    ...
    <div class="tw-flex tw-max-w-[650px] tw-flex-col tw-gap-5">
      <div class="tw-flex tw-gap-5 max-md:tw-flex-col">
        <div>
          <?php $image = "/assets/images/homepage/coffee.jpg";
          $title = "Coffee";
          require __DIR__ . '/components/menu-item.php'; ?>
        </div>
        <div>
          <?php $image = "/assets/images/homepage/lunch.jpg";
          $title = "Lunch";
          require __DIR__ . '/components/menu-item.php'; ?>
        </div>
      </div>
      <div>
        <?php $image = "/assets/images/homepage/dinner.jpg";
          $title = "Dinner";
          require __DIR__ . '/components/menu-item.php'; ?>
      </div>
    </div>
    ...
    <div class="tw-flex tw-flex-col tw-gap-5">
      <div>
        <?php $image = "/assets/images/homepage/breakfast.jpg";
          $title = "Breakfast";
          require __DIR__ . '/components/menu-item.php'; ?>
      </div>
      <div>
        <?php $image = "/assets/images/homepage/wine.jpeg";
          $title = "Drinks";
          require __DIR__ . '/components/menu-item.php'; ?>
      </div>
      <div>
        <?php $image = "/assets/images/homepage/dessert.jpg";
          $title = "Desserts";
          require __DIR__ . '/components/menu-item.php'; ?>
      </div>
    </div>
